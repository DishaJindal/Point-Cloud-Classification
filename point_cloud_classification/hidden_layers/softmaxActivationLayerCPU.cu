...
namespace PointCloudClassification {
	...
	*/
	std::vector<float*> softmaxActivationLayerCPU::forward(std::vector<float*> inputArg, bool test) {
	...
	std::vector<float*> softmaxActivationLayerCPU::backward(std::vector<float*> incomingGradient, float learningRate) {
